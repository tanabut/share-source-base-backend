...
class LoggingServiceV2Client {
    ...
    constructor(opts) {
        ...
        this.descriptors.stream = {
            tailLogEntries: new this._gaxModule.StreamDescriptor(gax.StreamType.BIDI_STREAMING),
        };
    ...
    initialize() {
        ...
        for (const methodName of loggingServiceV2StubMethods) {
            ...
            const descriptor = this.descriptors.page[methodName] ||
                this.descriptors.stream[methodName] || ((_a = this.descriptors.batching) === null || _a === void 0 ? void 0 : _a[methodName]) ||
                undefined;
